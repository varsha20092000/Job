...
class ProfileForm(forms.ModelForm):
    dob = forms.DateField(
        widget=forms.DateInput(
            attrs={'type': 'date', 'class': 'w-full mt-1 px-3 py-2 border border-gray-300 rounded'}
        ),
        input_formats=['%Y-%m-%d']
    )
    class Meta:
        ...
        widgets = {
            ...
            'short_bio': forms.Textarea(attrs={'rows': 3, 'class': 'w-full mt-1 px-3 py-2 border border-gray-300 rounded'}),
